...
void setup() {
    Log.begin(LOG_LEVEL_DEFAULT, 115200L);  // LOG_LEVEL_INFO
    delay(1000);
}
...
void loop() {
    ...
    Log.debug("This is bool mBool1=%d mBool1=%s", mBool1, (mBool1 ? "true" : "false"));   // Do not print to Serial
    Log.verbose("This is bool mBool2=%d mBool2=%s", mBool2, (mBool2 ? "true" : "false")); // Do not print to Serial
